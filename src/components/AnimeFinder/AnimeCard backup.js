  ...
  return (
    <>
      <Col md="10" xl="5" sm="6" className="p-2 my-2 mx-auto text-white">
        <div className="card mb-3 bg-dark" onClick={()=> window.open(url, "_blank")}>
          <div className="row no-gutters">
            <div className="col-md-3 col-xl-4 col-sm-12 ">
              <img src={imgUrl} className="card-img" alt="..." className="img-responsive" />
              <div className="row info-text float-left card-text d-none d-md-block d-lg-none">
            ...
            <div className="col-md-9 col-sm-12 col-xl-8">
              ...
              <div className="card-body">
                ...
                <div className="row info-text float-left card-text d-none d-xl-block d-lg-block">
                  <ul className="info-list p-3">
                    <li><b>Episodes: </b> {episodes}</li>
                    {/* <li><b>Aired date: </b>{cutDate(start_date)}</li> */}
                    <li><b>Type: </b> {type}</li>
